...
func loadArguments() *launchArgs {
	...
	getopt.FlagLong(&args.Flags.MonitorURL, "monitor-url", 'm', "monitor API endpoint", "https://banana.dev.enix.io/api")
	...
	getopt.FlagLong(&args.Flags.Vault.Addr, "vault-addr", 0, "vault API URL", "http://banana.dev.enix.io:8200")
